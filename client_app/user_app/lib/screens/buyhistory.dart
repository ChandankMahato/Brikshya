...
class BuyOrderHistory extends StatefulWidget {
  const BuyOrderHistory({Key? key}) : super(key: key);
  static const String id = "/buyorderhistory";
  @override
  State<BuyOrderHistory> createState() => _UserOrderHistoryState();
}

class _UserOrderHistoryState extends State<BuyOrderHistory> {
  @override
                      ...
                      child: FutureBuilder(
                        ...
                        builder: ((context, snapshot) {
                          return FutureBuilder<List>(
                            future: SellsDatabase.userSellsHistory(),
                            builder: ((context, snapshot) {
                              if (!snapshot.hasData) {
                                  ...
                                  children: [
                                    ...
                                    const Padding(
                                      ...
                                      child: CustomTextStyleOne(
                                        text:
                                            'Do you wants to Sell something ?',
                                        fontSize: 20,
