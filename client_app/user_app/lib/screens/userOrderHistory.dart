...
class UserOrderHistory extends StatefulWidget {
  ...
  static const String id = "/userOrderhistory";
  @override
  State<UserOrderHistory> createState() => _BuyHistoryState();
}

class _BuyHistoryState extends State<UserOrderHistory> {
                      ...
                      child: FutureBuilder(
                        ...
                        builder: ((context, snapshot) {
                          return FutureBuilder<List>(
                            future: OrderDatabase.userOrderHistory(),
                            builder: ((context, snapshot) {
                              if (!snapshot.hasData) {
